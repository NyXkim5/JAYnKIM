...
const projects = [
  {
    ...
    slug: "archv",
    title: "Archv",
    description: "Founded AI compliance startup. Ran 40+ user interviews. Chose RAG over fine-tuning based on cost, accuracy, and updatability. Targeted students first to build an institutional adoption pipeline. Killed two underperforming features in pilot. Cut review time by 71%.",
